...
- You may rename the variables according to your needs .
    for e.g :
        you may rename `sample_api_v2_bp` to `module_v2`

- In case you don't require versioning altogether , you may move out
    this file & delete the `/v2` folder altogether
...
sample_api_v2_bp = Blueprint(
    'sample_api_v2',
    __name__,
)

# You may remove the below api :
@sample_api_v2_bp.route('/sample-route', methods=['GET'])
def sample_route():
